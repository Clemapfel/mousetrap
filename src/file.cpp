...
s
    ...
    FilePath FileSystem::file_uri_to_file_path(const FileURI& uri)
    {
        GError* error = nullptr;
    ...
    std::vector<FileDescriptor> FileSystem::get_all_files_in_directory(const FilePath& path, bool recursive, bool list_directories)
    {
