...
namespace mousetrap
{
    inline StackSidebar::StackSidebar(Stack* stack)
    ...
    inline StackSwitcher::StackSwitcher(Stack* stack)
    ...
    inline StackID Stack::add_child(Widget* widget, const std::string& title)
    {
        auto id = _current_id++;
