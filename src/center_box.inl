...
namespace mousetrap
{
    inline CenterBox::CenterBox(GtkOrientation orientation)
    ...
    inline void CenterBox::set_start_widget(Widget* widget)
    {
        gtk_center_box_set_start_widget(get_native(), widget->operator GtkWidget*());
    }

    inline void CenterBox::set_end_widget(Widget* widget)
    {
        gtk_center_box_set_end_widget(get_native(), widget->operator GtkWidget*());
    }

    inline void CenterBox::set_center_widget(Widget* widget)
    {
        gtk_center_box_set_center_widget(get_native(), widget->operator GtkWidget*());
    }

    inline void CenterBox::set_baseline_position(GtkBaselinePosition position)
    {
