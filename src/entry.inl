...
namespace mousetrap
{
    ...
    inline void Entry::set_has_frame(bool b)
    {
        gtk_entry_set_has_frame(get_native(), b);
    }

    inline std::string Entry::get_text() const
    {
        auto* buffer = gtk_entry_get_buffer(get_native());
        return gtk_entry_buffer_get_text(buffer);
    }

    inline void Entry::set_text(const std::string& text)
    {
        auto* buffer = gtk_entry_get_buffer(get_native());
    ...
    inline void Entry::set_n_chars(size_t n)
    {
