...
namespace mousetrap
{
    ...
    void PaletteView::PaletteControlBar::update_palette_locked()
    {
        ...
        _palette_locked_button.set_active(not _owner->_palette_locked);
    ...
    PaletteView::PaletteControlBar::PaletteControlBar(PaletteView* owner)
            : _owner(owner)
    {
        _palette_locked_button.set_active(not owner->_palette_locked);
        _palette_locked_button.set_child(owner->_palette_locked ? &_palette_locked_icon : &_palette_not_locked_icon);
