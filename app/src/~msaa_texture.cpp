...
namespace mousetrap
{
        ...
        : _n_samples(n_samples)
    {
        ...
        _area.add_tick_callback([](FrameClock clock, AntiAliasedGLArea* instance) {
    ...
    AntiAliasedGLArea::operator Widget*()
    {
        return &_area;
    }

    void AntiAliasedGLArea::on_area_realize(Widget* widget, AntiAliasedGLArea* instance)
    {
    ...
    void AntiAliasedGLArea::on_area_resize(GLArea* area, int w, int h, AntiAliasedGLArea* instance)
    {
        instance->_canvas_size ={w, h};
        area->queue_render();
    }

    bool AntiAliasedGLArea::on_area_render(GLArea* area, GdkGLContext*, AntiAliasedGLArea* instance)
    {
        area->make_current();
        instance->render();
        return true;
    ...
    void AntiAliasedGLArea::realize()
    {
        size_t n_samples = 8;
