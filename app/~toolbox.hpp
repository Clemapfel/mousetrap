...
namespace mousetrap
{
    class Toolbox : public Widget
    {
        ...
        private:
            ...
            using on_icon_activate_data = struct { ToolID tool_id; std::vector<Icon*>* icons; Toolbox* instance;};
            ...
            using on_global_key_pressed_data = struct { ToolID tool_id; Toolbox* instance; };
...
namespace mousetrap
{
    Toolbox::Toolbox()
    {
        ...
        for (ToolID id : {
            ...
            state::main_window->register_global_shortcut(
                    state::shortcut_map,
                    "toolbox." + id,
                    on_global_key_pressed,
                    new on_global_key_pressed_data{id, this});
        }
    }

    void Toolbox::select_tool(ToolID id)
    {
        std::cout << "Selected Tool: " << id << std::endl;
    }
    ...
    void Toolbox::on_icon_activate(GtkButton*, void* instance)
    {
        ...
        data->instance->select_tool(data->tool_id);
    ...
    void Toolbox::on_global_key_pressed(void* data)
    {
        auto* instance = ((on_global_key_pressed_data*) data)->instance;
        auto id = ((on_global_key_pressed_data*) data)->tool_id;
