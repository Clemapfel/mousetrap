...
namespace mousetrap
{
    ...
    class ReorderableListView : public WidgetImplementation<GtkOverlay>
    {
        ...
        private:
            static void on_list_item_factory_setup(GtkSignalListItemFactory* self, void* object, ReorderableListView* instance);
            static void on_list_item_factory_teardown(GtkSignalListItemFactory* self, void* object, ReorderableListView* instance);
...
namespace mousetrap
{
    ...
    static ReorderableListItem* reorderable_list_item_new(Widget* in, ReorderableListView* owner)
    {
        ...
        item->box = new Box(GTK_ORIENTATION_VERTICAL);
        item->owner = owner;
...
namespace mousetrap
{
    ReorderableListView::ReorderableListView(GtkOrientation orientation, GtkSelectionMode mode)
        ...
        auto* label = gtk_label_new("test");
        gtk_fixed_put(_fixed, GTK_WIDGET(_fixed_overlay_box), 0, 0);
        gtk_box_append(_fixed_overlay_box, GTK_WIDGET(label));
